...
function About() {
	return (
		<div id="about" className="text-center px-4 py-20 max-w-3xl mx-auto">
			...
			<p className="text-neutral-600 text-base sm:text-lg">
				Digital Laboratory is a multidisciplinary hub where Digital Systems and
				Programming meet, empowering students through hands-on innovation and
