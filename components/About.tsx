...
function About() {
	return (
		<div
			id="about"
			className="min-h-screen text-center px-4 py-16 max-w-3xl mx-auto"
		>
			...
			<p className="text-neutral-600 text-base sm:text-lg">
				Digital Laboratory is a multidisciplinary lab that brings together areas
				from Digital Systems to Programming, empowering students with hands-on
				experience and collaborative learning to shape the future of technology.
			</p>
