...
CREATE POLICY "insert" ON "public"."applicants" FOR INSERT WITH CHECK (("auth"."uid"() = "id"));



CREATE POLICY "select" ON "public"."applicants" FOR SELECT USING (("auth"."uid"() = "id"));



CREATE POLICY "update" ON "public"."applicants" FOR UPDATE USING (("auth"."uid"() = "id"));
